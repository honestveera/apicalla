class LoginsController < ApplicationController
  ...
  # GET /logins/1.json
  def show
    #format.xml { render :show, status: :created, location: @login }
  end
  ...
  def create
    ...
    respond_to do |format|
      if @login.save
        ...
        format.xml {render :xml => @login.to_xml }
      else
  ...
  private
    ...
    def login_params
      params.require(:login).permit(:username, :email, :password, :conformpassword, :mobilenumber)
    end
end
